...
$(document).ready(function () {
    ...
    $('#basic-alert').on('click', function () {
      Swal.fire({
        title: 'Any asdad fool can use a computer',
    ...
    $('#custom-icon').on('click', function () {
      Swal.fire({
        title: 'TESTING!!@!!',
        text: 'Testers are the best!',
        imageUrl: 'https://blue.kumparan.com/image/upload/fl_progressive,fl_lossy,c_fill,q_auto:best,w_640/v1637551625/zp98a0y3wl8atnk0rzze.jpg',
        customClass: 'animated flipInX',
        imageWidth: 400,
        imageHeight: 200,
