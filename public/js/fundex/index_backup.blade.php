...
<html lang="zxx" dir="ltr">
	<head>
		...
		<link href="{{ asset('css/custom1.css?v='.rand(0,999))}}" rel="stylesheet">
	...
	<body>
						...
						<div id="home" class="main-content">
							...
							<div class="inner-content">
								...
								<div class="head-content">
									<h3>Hi I'M <a href="#"><span class="name" onclick="changeColor()" title="Click me for change the theme">Muhammad Lingga</span></a></h3>
													...
													<li>
														<ul>
															...
															<li class="single-skill">
																<ul>
																	<li class="skill-name">
																		<i class="fas fa-angle-double-right"></i><span>Python</span>
																	</li>
																	<!-- Range Of Percentage 0% - 100% -->
															...
															<li class="single-skill">
																<ul>
																	<li class="skill-name">
																		<i class="fas fa-angle-double-right"></i><span>Video Editing</span>
																	</li>
																	<!-- Range Of Percentage 0% - 100% -->
																	<li class="percentage">90%</li>
																	<li class="progress-wrapper">
															...
															<li class="single-skill">
																<ul>
																	<li class="skill-name">
																		<i class="fas fa-angle-double-right"></i><span>Photo Editing</span>
																	</li>
																	<!-- Range Of Percentage 0% - 100% -->
																	<li class="percentage">75%</li>
																	<li class="progress-wrapper">
												...
												<ul>
													...
													<li>
														<ul>
															...
															<li class="experience-body">- Mengolah &amp; Menggoreng Donat, Croissant, Burger.<br>- Membuat Suatu Fillingan Donat agar Menciptakan Rasa Yang Berbeda.<br>- Mentopping Donat Agar Terlihat Lebih Menarik.</li>
														</ul>
													</li>
												</ul>
											</div>
										...
										<div class="row no-gutters">
											...
											<div class="portfolio-item col-12">
												<div class="item-wrapper row">
													...
													<!-- Single Item Starts -->
													<div class="item Website col-md-4 col-sm-6 col-12">
														<!-- Image Starts -->
														<div class="image">
													...
													<!-- Project Apps Starts -->
													<!-- Single Item Starts -->
													<div class="item Apps ol-md-4 col-sm-6 col-12">
														<!-- Image Starts -->
														<div class="image">
		...
		<script>
			toastr.info('Welcome to my Personal Home Page', '~ Muhammad Lingga ~', {timeOut: 5000});
		</script>

		<script>
			let movessss = document.addEventListener('mousemove', function(e) {
				let body = document.querySelector('body');
				let hati = document.createElement('small');
				let x = e.offsetX;
				let y = e.offsetY;
				hati.style.left = x+'px';
				hati.style.top = y+'px';
			
				body.appendChild(hati);  // appendChild(element)
				setTimeout(() => {
					requestAnimationFrame(() => {
						body.removeChild(hati);
					}, 1000 / 60);
				// hati.remove();
				// }, 1000);
			});
